 ...
 */
public class v_forgot_password extends javax.swing.JFrame {

    /**
     * Creates new form lupa_password
     */
    public v_forgot_password() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_forgot_password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_forgot_password().setVisible(true);
            }
        });
    }

 ...
 */
public class v_recordingAnimal_nurse extends javax.swing.JFrame {

    /**
     * Creates new form recordingAnimal_perawatan
     */
    public v_recordingAnimal_nurse() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_recordingAnimal_nurse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_recordingAnimal_nurse().setVisible(true);
            }
        });
    }

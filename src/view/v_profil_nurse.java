 ...
 */
public class v_profil_nurse extends javax.swing.JFrame {

    /**
     * Creates new form profil_nurse
     */
    public v_profil_nurse() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_profil_nurse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_profil_nurse().setVisible(true);
            }
        });
    }
